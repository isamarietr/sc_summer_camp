...
ip1=$(VBoxManage guestproperty get log1 "/VirtualBox/GuestInfo/Net/0/V4/IP" | awk '{ print $2 }')
ip2=$(VBoxManage guestproperty get lo2 "/VirtualBox/GuestInfo/Net/0/V4/IP" | awk '{ print $2 }')
ip3=$(VBoxManage guestproperty get log3 "/VirtualBox/GuestInfo/Net/0/V4/IP" | awk '{ print $2 }')
